...
from kblam.kb_encoder import LKIFEncoder
import torch
...
class LKIFProcessor(ProcessorMixin):
    ...
    def load_encoder(self, args: EncoderArgs):
        # Load LKIF encoder (previously KB encoder)
        encoder = LKIFEncoder(
    ...
    def __call__(
        ...
        if (
            ...
            # If precomputed base embeddings are provided
        ...
        return BatchFeature(data={**text_inputs, "lkif_kvs": knowledge_base})
