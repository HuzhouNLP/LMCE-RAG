...
LANGUAGE="en"        # Language for the input data (e.g., zh for Chinese, en for English, etc.)
...
NUMBER=200 # Number of irrelevant questions to generate (recommended: 3 per document × 10 documents)
